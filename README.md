...
單一 HTML 檔案的行程小網站，內含班機資訊、Day1–3 行程時間軸、新加坡出境須知、咖椰醬採買攻略、付款與預算、長輩飲食注意、行前準備清單（可勾選、會記住狀態）、住宿與美食資訊。

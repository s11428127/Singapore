...
單一 HTML 檔案的行程小網站，內含班機資訊、Day1–3 行程時間軸、新加坡出境須知、咖椰醬採買攻略、行前準備清單（可勾選、會記住狀態）、住宿與美食資訊。

行程中的重要關卡都附有可展開的「現場指引」：怎麼走、怎麼點餐、怎麼買票、現場會遇到什麼狀況，以及四張手繪的 SVG 動線圖（樟宜 T3 出境動線、濱海灣花園晚間步行動線、桃園與樟宜出境流程對照、咖椰醬購買時機）。所有圖都直接寫在 HTML 裡，不依賴外部圖床，離線也看得到。
